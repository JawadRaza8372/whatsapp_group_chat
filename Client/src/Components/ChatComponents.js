...
setinputv('')
    ...
    return (
        <div className="chat">
          ...
          {allroomdata && allroomdata.map((dat)=>{
            console.log(dat._id);
        ...
        <br/>
            {data.map((dat)=>{
              if (dat.roomId === `${thisroomId}`){
                ...
                return ( <p className="chat_message  chat_reciver">
...
<form onSubmit={submitfun}>
    <input value={inputval} onChange={(e)=>setinputv(e.target.value)} type="text" placeholder="Your Message"/>
